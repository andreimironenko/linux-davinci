...
#define VID_ENC_STD_720P_60_1610 "720P-60-16:10"		// DJS - 1152x720 16:10 version of 720P
...
#define DAVINCI_VID_ENC_FLAG_NEG_HSYNC		(0)
#define DAVINCI_VID_ENC_FLAG_NEG_VSYNC		(0)
#define DAVINCI_VID_ENC_FLAG_POS_HSYNC		(1 << 0)
#define DAVINCI_VID_ENC_FLAG_POS_VSYNC		(1 << 1)

#define DAVINCI_VID_ENC_FLAGS_NEG_SYNC		(DAVINCI_VID_ENC_FLAG_NEG_HSYNC | DAVINCI_VID_ENC_FLAG_NEG_VSYNC)
#define DAVINCI_VID_ENC_FLAGS_POS_SYNC		(DAVINCI_VID_ENC_FLAG_POS_HSYNC | DAVINCI_VID_ENC_FLAG_POS_VSYNC)
