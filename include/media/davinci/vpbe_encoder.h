...
#define VPBE_ENCODER_MAX_NUM_STD			(13 + 1)		// DJS +1 for 720P60-16:10
...
#define VPBE_DM365_ENCODER_COMPONENT_NUM_STD		(9 + 1)		// DJS + 1 for 720P60-16:10
//#define VPBE_DM365_ENCODER_COMPONENT_NUM_STD		(2)			// DJS - 720P and 720P60-16:10 only
