...
struct davinci_vpbe_platform_data {
	enum soc_type type;
};
...
#define	VENC_EPSON_LCDCTL			(0xB4)
#define	VENC_CASIO_LCDCTL			(0xB4)
#define	VENC_UDISP_LCDCT			(0xB4)
#define	VENC_STN_LCDCT				(0xB4)
...
#define		OSD_WINOFST(i)			(0x18 + (i)*0x4)
...
#define		OSD_WINADR(i)			(0x2C + (i)*0x4)
...
#define	OSD_WINXP(i)				(0x48 + (i)*0x10)
#define	OSD_WINYP(i)				(0x4C + (i)*0x10)
#define	OSD_WINXL(i)				(0x50 + (i)*0x10)
#define	OSD_WINYL(i)				(0x54 + (i)*0x10)
...
#define	OSD_W1BMP0				(0xC0)
#define	OSD_W1BMP2				(0xC4)
#define	OSD_W1BMP4				(0xC8)
#define	OSD_W1BMP6				(0xCC)
#define	OSD_W1BMP8				(0xD0)
#define	OSD_W1BMPA				(0xD4)
#define	OSD_W1BMPC				(0xD8)
#define	OSD_W1BMPE				(0xDC)
#define	OSD_TI_TES				(0xE0)
#define OSD_EXTMODE				(0xE4)
#define	OSD_MISCCT				(0xE8)
#define	OSD_CLUTRAMYC				(0xEC)
#define	OSD_CLUTRAMC				(0xF0)
#define	OSD_TRANSPVA				(0xF0)
#define	OSD_PPVWIN0AD				(0xFC)
